...
/**
 * BishopRawLearningUnit.
 *
 * @author Alejandro
 *
 */
public class BishopRawLearningUnit extends AbstractRawLearningUnit {
    ...
    /**
     * Constructor for BishopRawLearningUnit.
     *
     * @param tablero
     *            tablero
     * @param movimiento
     ...
     *            bando
     */
    public BishopRawLearningUnit(final Tablero tablero, final Movimiento movimiento, final Bando bando) {
    ...
    public double[] getOutput() {
        ...
        final Ficha ficha = checkFicha(TipoFicha.ALFIL);
        ...
        // DeepLearningUtils.printArray(output);
