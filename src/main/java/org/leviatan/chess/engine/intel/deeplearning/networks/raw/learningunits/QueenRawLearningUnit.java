...
/**
 * QueenRawLearningUnit.
 *
 * @author Alejandro
 *
 */
public class QueenRawLearningUnit extends AbstractRawLearningUnit {

    /** NUM_DIRECCIONES. */
    public static final int NUM_DIRECCIONES = 8;

    /** NUM_INTENSIDADES. */
    public static final int NUM_INTENSIDADES = 7;

    /** NUM_OUTPUTS = Dirección + intensidad + num fichas. */
    public static final int NUM_OUTPUTS = NUM_DIRECCIONES + NUM_INTENSIDADES + 9;

    /**
     * Constructor for QueenRawLearningUnit.
     *
     * @param tablero
     *            tablero
     * @param movimiento
     ...
     *            bando
     */
    public QueenRawLearningUnit(final Tablero tablero, final Movimiento movimiento, final Bando bando) {
    ...
    public double[] getOutput() {
        ...
        final Ficha ficha = checkFicha(TipoFicha.REINA);
